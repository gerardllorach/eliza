...
// Constructor
function Speech(lang, gender){
  this.utterance = new SpeechSynthesisUtterance("");
  this.utterance.lang = lang || 'en-US';
  if (gender)
  	this.utterance.voice = speechSynthesis.getVoices().filter(function(v) {return v.name.includes(gender)&&v.lang.includes(lang.split("-")[0]);})[0];
  console.log("VOICE", this.utterance.voice, lang);
}
